...
export default async function ProfilePage() {
  ...
  return <div className="cb-container cb-page">
    <header className="mb-5 flex flex-wrap items-start justify-between gap-6 rounded-2xl border border-forest-200 bg-mint/65 p-6 sm:p-8">
    ...
    <nav aria-label="Your journey" className="mb-7 grid gap-2 rounded-2xl border border-ink-200 bg-white p-2 sm:grid-cols-3">
      <div className="flex items-center gap-3 rounded-xl bg-mint/65 px-4 py-3"><span className="grid h-8 w-8 place-items-center rounded-full bg-forest-700 text-xs font-bold text-white">1</span><span><span className="block text-xs font-bold uppercase tracking-[.12em] text-forest-700">Done</span><span className="block text-sm font-semibold text-ink-800">Tell us about you</span></span></div>
      <div className="flex items-center gap-3 rounded-xl border border-forest-200 bg-forest-50 px-4 py-3"><span className="grid h-8 w-8 place-items-center rounded-full border border-forest-500 bg-white text-xs font-bold text-forest-700">2</span><span><span className="block text-xs font-bold uppercase tracking-[.12em] text-forest-700">You are here</span><span className="block text-sm font-semibold text-ink-800">Choose an area to explore</span></span></div>
      <div className="flex items-center gap-3 rounded-xl px-4 py-3"><span className="grid h-8 w-8 place-items-center rounded-full border border-ink-200 bg-ink-50 text-xs font-bold text-ink-500">3</span><span><span className="block text-xs font-bold uppercase tracking-[.12em] text-ink-400">Next</span><span className="block text-sm font-semibold text-ink-600">Compare routes and plan</span></span></div>
    </nav>
    ...
    <div className="grid items-start gap-6 lg:grid-cols-[minmax(0,.9fr)_minmax(0,1.25fr)] 2xl:gap-10">
      ...
      <section className="order-1 min-w-0 rounded-[1.5rem] border border-forest-200 bg-[#edf3e9] p-5 sm:p-7 lg:order-2" aria-labelledby="starting-points-title" id="starting-points">
        <div className="flex items-start gap-3"><span className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-forest-700 text-white"><Compass aria-hidden className="h-5 w-5" /></span><div><Eyebrow>Your next step</Eyebrow><h2 id="starting-points-title" className="mt-1 text-[1.45rem] font-semibold">Choose one area to explore.</h2><p className="mt-2 text-sm text-ink-600">There is no best answer. Open one that makes you curious, then look around.</p></div></div>
